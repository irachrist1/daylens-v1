...
const EXTENSION_SPECS: Record<string, TileSpec> = {
  ...
  doc: { label: 'W', background: '#2b579a', color: '#ffffff' },
  docx: { label: 'W', background: '#2b579a', color: '#ffffff' },
  xls: { label: 'X', background: '#1f8f4d', color: '#ffffff' },
  xlsx: { label: 'X', background: '#1f8f4d', color: '#ffffff' },
  ppt: { label: 'P', background: '#c43e1c', color: '#ffffff' },
  pptx: { label: 'P', background: '#c43e1c', color: '#ffffff' },
